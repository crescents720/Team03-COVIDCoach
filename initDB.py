...
class initDB():
    ...
    def buildNewsTable(self):
        ...
        c.execute(
            'CREATE TABLE IF NOT EXISTS news_table(news_id REAL, source_id TEXT, source_name TEXT, author TEXT, title TEXT, description TEXT, url TEXT, url_to_image TEXT, publish_date TEXT, content TEXT)')
        # 该表字段包括：
